...
export NODE_PROJECT_NAME="zhengshuwangzhan"
cd /www/wwwroot/diploma.dpdns.org/src/server
nohup /www/server/nodejs/v16.9.0/bin/node /www/wwwroot/diploma.dpdns.org/src/server/server.js  &>> /www/wwwlogs/nodejs/zhengshuwangzhan.log &
echo $! > /www/server/nodejs/vhost/pids/zhengshuwangzhan.pid
